  ...
  export default {
    ...
    methods:{
      toSearchProfessional(){
        ...
        this.$axios.get(this.global.ip+"/index/getProfessionalRent/"+id,{params:{"searchName":this.value}})
        ...
        this.$axios.get(this.global.ip+"/index/getProfessionalSale/"+id,{params:{"searchName":this.value}})
          .then(function (result) {
            if (result.data.status != false) {
