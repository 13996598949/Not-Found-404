  ...
  export default {
    ...
    methods:{
      toSearchRecommend(){
        ...
        this.$axios.get(this.global.ip+"/index/getRecommendRent/"+id,{params:{"searchName":this.value}})
        ...
        this.$axios.get(this.global.ip+"/index/getRecommendSale/"+id,{params:{"searchName":this.value}})
          .then(function (result) {
            if (result.data.status != false) {
