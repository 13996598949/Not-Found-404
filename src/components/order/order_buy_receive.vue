<template>
  <div>
    ...
    <van-row gutter="1">
      <center><van-col span="12"><van-button class="vanCloseButton" bottom-action @click="refund">我要退款</van-button></van-col></center>
      <center><van-col span="12"><van-button class="vanButton" bottom-action @click="receive">确认收货</van-button></van-col></center>
    </van-row>
