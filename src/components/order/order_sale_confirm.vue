<template>
  <div>
    ...
    <van-cell-group>
      ...
      <center><van-button class="vanButton" bottom-action @click="show = true">评价买家</van-button></center>
...
export default {
  ...
  methods: {
    ...
    toEvaluate(){
      ...
      this.evaluateDto.tallPersonId = this.orderData.sellId;
      this.evaluateDto.talledPersonId = this.orderData.buyId;
      this.evaluateDto.evaluate = this.evaluate;
      this.evaluateDto.goodFlag = this.good;
      this.evaluateDto.flag = "sale";
      var that = this;
      if (this.flag=="rent") {
